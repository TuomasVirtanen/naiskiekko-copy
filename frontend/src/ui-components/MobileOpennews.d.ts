...
export declare type MobileOpennewsOverridesProps = {
    MobileOpennews?: PrimitiveOverrideProps<FlexProps>;
...
export declare type MobileOpennewsProps = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: MobileOpennewsOverridesProps | undefined | null;
}>;
export default function MobileOpennews(props: MobileOpennewsProps): React.ReactElement;
